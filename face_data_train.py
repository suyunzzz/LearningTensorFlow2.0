...
from face_data_preProcess import load_dataset, resize_image, IMAGE_SIZE
...
class CNN(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.dense4 = tf.keras.layers.Dense(units=3)  # 最后分类 5个单位
...
if __name__ == '__main__':
    ...
    dataset = Dataset('./face/face_data/')  # 数据都保存在这个文件夹下
    dataset.load()
    ...
    for epoch in range(EPOCHS):  #训练120轮
