...
def load_dataset(path_name):
    ...
    temp = 0
    for label in labels:
        if label.endswith('suyunzheng'):
            labels[temp] = 0    #suyunzheng标注为0
        elif label.endswith('mk'):
            labels[temp] = 1      #mk标注为1
        elif label.endswith('sushuchang'):
            labels[temp] = 2     #sushuchang标注为2
...
if __name__ == '__main__':
    images, labels = load_dataset("C:/Users/11604/Desktop/DL/FaceDectect/face/face_data")
    # print(images.shape)
    print(labels[0])
    print(labels[201])
    print(labels[401])
