...
if __name__ == '__main__':
    ...
    # 人脸识别分类器本地存储路径
    cascade_path = "D:/ProgramData/Anaconda3/pkgs/opencv-3.3.1-py36h20b85fd_1/Library/etc/haarcascades/haarcascade_frontalface_alt2.xml"
    ...
    while True:
        ...
        if len(faceRects) > 0:
            for faceRect in faceRects:
                ...
                draw.text((x + 25, y - 95), 'suyunzheng:{:.2%}'.format(face_probe[0]), (255, 0, 0), font=font)
                draw.text((x + 25, y - 70), 'mk:{:.2%}'.format(face_probe[1]), (255, 0, 0), font=font)
                draw.text((x + 25, y - 45), '爹:{:.2%}'.format(face_probe[2]), (255, 0, 0), font=font)
